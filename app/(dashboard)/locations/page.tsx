  ...
  return (
    <div className="min-h-full p-8">
      <div className="max-w-5xl">
        <div className="mb-10">
          <h1 className="text-2xl font-bold text-gradient tracking-tight mb-1">Locations</h1>
          <p className="text-white/30 text-sm">Manage your Google Business Profile connections and posting schedule.</p>
        </div>

        {locations && locations.length > 0 ? (
          <div className="space-y-3">
            {locations.map((loc) => (
              <div key={loc.id} className="glass-bright rounded-2xl p-6">
